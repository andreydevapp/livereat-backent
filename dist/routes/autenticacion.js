...
const autenticacion_1 = require("../controller/client/autenticacion");
const imagenDeUsuario_1 = __importDefault(require("../libs/imagenDeUsuario"));
const router = express_1.Router();
var token2 = '';
//para registrar un nuevo usuario 
router.route('/registrar_usuario')
    .post(imagenDeUsuario_1.default.single('imagen'), autenticacion_1.crearNuevoUsuario);
router.route('/iniciar_sesion')
    .post(autenticacion_1.loguearse);
router.route('/iniciar_sesion_por_token')
    .post(autenticacion_1.loguearsePorToken);
